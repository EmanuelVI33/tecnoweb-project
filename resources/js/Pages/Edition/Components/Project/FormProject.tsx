...
const formSchema = z.object({
    ...
    presenter_id: z
        .string()
        .min(1, { message: "Seleccione un presentador para su proyecto" }),
});
            ...
            <form onSubmit={form.handleSubmit(submit)}>
                ...
                <FormField
                  ...
                  /> */}
                                    ...
                                    >
                                        <input {...getInputProps()} />
                                        Drag & Drop to Upload Image or Click to
                                        Select
                                    </div>
                                </>
                            </FormControl>
                ...
                <div className="flex justify-between gap-5 mt-5">
                    ...
                    <Button type="submit" disabled={processing}>
                        {modalState.isEditing ? "Actualizar" : "Registrar"}
                    </Button>
                </div>
            </form>
        </Form>
...
const getInitialProject = (
    ...
    if (modalState.isEditing) {
        const projectInit = projects.find(
            (project) => project.id === modalState.currentId
        );
        if (projectInit) {
            return {
                id: projectInit.id,
