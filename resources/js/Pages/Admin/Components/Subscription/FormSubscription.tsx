...
const fields = [
  ...
  { name: 'duration', label: 'Duración(Días)', placeholder: 'días', type: FormFieldType.NUMBER, },
  { name: 'price', label: 'Precio', placeholder: 'precio', type: FormFieldType.NUMBER, },
];
